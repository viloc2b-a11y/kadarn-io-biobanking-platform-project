...
/**
 * POST /api/v1/exchange/deals — Create a new exchange deal.
 * If total_value is provided, also creates an exchange_escrow record.
 */
export const POST = withAsyncTracing(
  ...
  SPAN_API_REQUEST,
  { attributes: { 'kadarn.api.route': 'exchange.deals', 'kadarn.api.method': 'POST' } },
)
