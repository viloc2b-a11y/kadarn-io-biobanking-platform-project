...
export interface ContributionDetails {
  evidenceUsed: import('@kadarn/evidence-core').EvidenceContribution[];
  evidenceOmitted: import('@kadarn/evidence-core').OmittedEvidence[];
  relationshipsTraversed: import('@kadarn/evidence-core').RelationshipContribution[];
  counterEvidenceConsidered: import('@kadarn/evidence-core').CounterEvidenceContribution[];
  responsesConsidered: import('@kadarn/evidence-core').ResponseContribution[];
  temporalContinuity: import('@kadarn/evidence-core').TemporalContribution;
