// ==========================================================================
// Engine output builder — consumed via Published View boundary (28D+)
// Moved from apps/api dashboard-engines; routes must not call this directly.
// ==========================================================================
...
function buildAssessment(
  capIntelligence: ReturnType<typeof buildCapabilityIntelligence>,
